<div>
    <section class="relative h-screen flex items-center justify-center text-white overflow-hidden">
        ...
        <!-- Content -->
        <div class="relative z-10 max-w-7xl mx-auto px-6 pt-24 sm:pt-28 lg:pt-36 text-center" x-data="{ show: false }" x-init="setTimeout(() => show = true, 100)">
            <h1 x-show="show" 
                ...
                class="text-4xl sm:text-6xl md:text-7xl font-bold mb-6 text-[#F1400C]">
            ...
            <p x-show="show"
               ...
               x-transition:enter-start="opacity-0 translate-y-8 sm:translate-x-32 sm:translate-y-0"
               x-transition:enter-end="opacity-100 translate-x-0 translate-y-0"
               class="text-lg sm:text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
